...
class StudentController extends Controller
{
    ...
    {
        $students = Student::query()->where('approved', true)->get();
    ...
    public function renderApprovalStudents()
    {
        ...
        $awaitingStudents = Student::query()->where('approved', '!=', true)->get();
        ...
        return view('panel.approval')
            ...
            ->with('awaitingStudents', $awaitingStudents);
    }

    public function approve($id)
    {
        $student = Student::query()->firstWhere('student_id', $id);
        $student->approved = true;
        $student->rejected = false;
        $student->save();
        return back()->with('success', 'Student is approved.');
    }
    ...
    public function reject($id)
    {
        ...
        $student->save();
        return back()->with('success', 'Student is rejected.');
    }
